...
# def main():
#     path_opendrive = r"/home/gz0779601/桌面/codes/MARL-LimSim/networkFiles/mix/mix.xodr"
#     road_info = parse_opendrive(path_opendrive)
#     for link in road_info.discretelanes:
#         print(link.lane_id, link.center_vertices)
